...
const PrePrimary = () => {
  ...
  return (
    <div className="pt-20 font-noto-sans-bengali sm:px-10">
      ...
      <div className="m-10 text-justify pl-40">
        <p>
          {" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-10">
        ...
        <div>
          ...
          <p className="text-justify ml-10 leading-loose">
            ...
            স্কুলে সফল হতে সহায়তা করে। <br /> <br />
...
<p className="pl-10 pr-20 -mt-8">
            ...
            <span className="font-bold flex items-center gap-2 pl-6 ">
              <FaCircle className="h-2 w-2" />
              একটি স্নেহময় পরিবেশ:
            </span>{" "}
            <p className="pl-10 pr-20">
            আমাদের গ্রেড ০ প্রোগ্রাম একটি উষ্ণ এবং বন্ধুত্বপূর্ণ পরিবেশ তৈরি
            করতে প্রতিশ্রুতিবদ্ধ, যেখানে প্রতিটি শিশু নিজেকে মূল্যবান এবং
            সমর্থিত বোধ করে। গঠিত শিক্ষণ এবং সৃজনশীল খেলাধুলার মিশ্রণের মাধ্যমে,
            আমরা একটি সুষম বিকাশ গড়ে তোলার চেষ্টা করি।
            </p>
          </p>
        </div>
        <div>
